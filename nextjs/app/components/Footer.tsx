        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 glass flex items-center justify-center hover:border-pink-500 hover:bg-pink-600/40 transition-all duration-300 hover:shadow-glow border-2 border-cyan-400/40 text-cyan-400 hover:text-pink-500">
                <FaLinkedin className="text-lg" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 glass flex items-center justify-center hover:border-pink-500 hover:bg-pink-600/40 transition-all duration-300 hover:shadow-glow border-2 border-cyan-400/40 text-cyan-400 hover:text-pink-500">
                <FaInstagram className="text-lg" />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 glass flex items-center justify-center hover:border-pink-500 hover:bg-pink-600/40 transition-all duration-300 hover:shadow-glow border-2 border-cyan-400/40 text-cyan-400 hover:text-pink-500">
